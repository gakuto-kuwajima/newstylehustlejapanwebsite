        ...
        <div class="col-md-10 mx-auto">
            ...
            <div class="section">
                ...
                <div class="who">
                    ...
                    <div class="lesson">
                        <h4 class="h4-title"><i class="fas fa-circle h4-title-lesson-before"></i>レギュラーclass</h4>
                        <div class="lesson-description">
                            <p>基本のステップを練習したあと、いくつか技を組み合わせて踊るオープンクラス</p>
                        </div>
                        <div class="detail">
                            <ul>
                                <li><p>日時：毎週月曜日 21:15〜22:45</p></li>
                                <li><p>料金：1名で参加2,000円　男女ペアで参加ペアで3,000円</p></li>
                                <li><p>場所：新宿ﾏｲｽﾀｼﾞｵ5B　http://shinjukustudio.jp/access/index.html</p></li>
                            </ul>
                            <div class="map">
                    ...
                    <div class="lesson">
                        ...
                        <div class="detail">
                            <p>日時：金曜日 21:15〜22:45<br>（毎月1回のみ。カレンダー要確認）</p>
                            <p>料金：体験2回まで1,500円</p>
                            <p>場所：三鷹 Dance StudioemotionS　http://dance-studio-emotions.com/</p>
                        </div>
                    </div>
                    <div class="lesson">
