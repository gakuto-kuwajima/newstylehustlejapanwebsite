                ...
                <div class="container">
                    <div class="footer-up">
                        ...
                        <div class="share-button">
                            <ul class="snsbtniti">
                  　            <!--twitter-->
                                <li><a href="https://twitter.com/share?url={{ url('/news') }}&text=ニュース - GAKUTOのニュースタイルハッスル情報部屋" rel="nofollow" target="_blank" class="flowbtn10"><i class="fab fa-twitter"></i></a></li>
                                <!--facebook-->
