        ...
        <div class="col-md-10 mx-auto contact-form">
            <div class="panel panel-default">
                ...
                <div class="section-h2">
                    ...
                    <p>当サイトはニュースタイルハッスル創始者のジェフとパートナーのロビンに許可をいただき、当初単純に情報を伝達するための目的で作成されていました。<br>しかし作成していく中で「公式サイトとして見られる可能性があり、記載漏れがあった場合、記載漏れのコミュニティが非公式と見られてしまうのではないか」というご指摘あったため、ならばいっそのこと当サイトを「非公式」としてしまおうということになりました。<br>ですがそもそも作成者はこのサイトを作成するにあたって公式、非公式などの考えは全くなく、当サイトに記載希望のニュースタイルハッスルのコミュニティはすべて記載させていただく考えであることもここに明記いたします。</p>
                </div>
                <div class="section-h2">
